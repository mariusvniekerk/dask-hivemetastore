...
import sys
import dask_hivemetastore._gen.fb303.ttypes
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i382 in range(_size378):
                        _elem383 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                ...
                if ftype == TType.LIST:
                    ...
                    for _i388 in range(_size384):
                        _elem389 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.properties is not None:
            ...
            for kiter525, viter526 in self.properties.items():
                oprot.writeString(kiter525.encode('utf-8') if sys.version_info[0] == 2 else kiter525)
                oprot.writeString(viter526.encode('utf-8') if sys.version_info[0] == 2 else viter526)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i552 in range(_size548):
                        _elem553 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                ...
                if ftype == TType.LIST:
                    ...
                    for _i558 in range(_size554):
                        _elem559 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i566 in range(_size562):
                        _elem567 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
